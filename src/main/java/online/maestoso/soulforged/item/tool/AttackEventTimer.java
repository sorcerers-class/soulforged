        ...
        switch(hitCounter) {
            case 1 -> {
                if(fullAttack) {
                    ...
                    target.damage(DamageSource.player((PlayerEntity) attacker), (float) ForgedToolItem.calcDamage(tool, 0));
                } else {
            ...
            case 2 -> {
                ...
                target.damage(DamageSource.player((PlayerEntity) attacker), (float) ForgedToolItem.calcDamage(tool, 1));
            }
            default -> {}
        }
    }
