...
public class Materials {
    ...
    public static final Material LEATHER = register(new Identifier("soulforged", "leather"), new ArmorMaterial(1, 5, 150, 250, 0, 20));
    public static final Material FLINT = register(new Identifier("soulforged", "flint"), new ToolMaterial(5, 4.5, 5, 660, 300, 0));
    public static final Material BONE = register(new Identifier("soulforged", "bone"), new Material(5, 3.8f, 5, 200, 100, 0, 0));
    public static final Material WOOL = register(new Identifier("soulforged", "wool"), new ArmorMaterial(0, 5, 80, 100, 0, 20));
    public static final Material SPIDER_WEAVE = register(new Identifier("soulforged", "spider_weave"), new ArmorMaterial(1, 5, 180, 1100, 0, 12));
    public static final Material SLIME_WEAVE = register(new Identifier("soulforged", "slime_weave"), new ArmorMaterial(0, 5, 300, 300, 0, 40));
    // Earlygame Metals
    public static final Material IRON = register(new Identifier("soulforged", "iron"), new Material(7, 5.8, 3, 600, 600, 3, 0));
    public static final Material COPPER = register(new Identifier("soulforged", "copper"), new Material(6, 5, 3, 570, 700, 3, 0));
    public static final Material GOLD = register(new Identifier("soulforged", "gold"), new Material(2, 2, 4, 1150, 150, 2, 3));
    public static final Material SILVER = register(new Identifier("soulforged", "silver"), new Material(5, 5, 3, 800, 670, 3, 0));
    public static final Material LEAD = register(new Identifier("soulforged", "lead"), new Material(4, 2.6, 4, 950, 300, 2, 1));
    public static final Material STEEL = register(new Identifier("soulforged", "steel"), new Material(8, 7, 2, 590, 850, 4, 0));
    // Earthly Crystals
    public static final Material AMETHYST = register(new Identifier("soulforged", "amethyst"), new CrystalMaterial(9, 12, 2, 400, 200));
    public static final Material EMERALD = register(new Identifier("soulforged", "emerald"), new CrystalMaterial(6, 7, 2, 440, 770));
    ...
    public static final Material MONSTER_LEATHER = register(new Identifier("soulforged", "monster_leather"), new ArmorMaterial(1, 5, 200, 800, 0, 30));
    public static final Material MONSTER_SCALES = register(new Identifier("soulforged", "monster_scales"), new ArmorMaterial(6, 3, 400, 690, 0, 15));
    // Corundum
    ...
    public static final Material NETHERITE = register(new Identifier("soulforged", "netherite"), new Material(10, 9, 3, 630, 1500, 5, 0));
    public static final Material ALUMINIUM = register(new Identifier("soulforged", "aluminium"), new Material(5, 6.8, 4, 320, 400, 3, 0));
    public static final Material TITANIUM = register(new Identifier("soulforged", "titanium"), new Material(8, 7.5, 1, 450, 900, 4, 0));
    // Endgame Alloys
    public static final Material VOID_METAL = register(new Identifier("soulforged", "void_metal"), new Material(9, 9, 1, 90, 1000, 4, 0));
    ...
    public static final Material MERCURIUM = register(new Identifier("soulforged", "mercurium"), new Material(7, 6, 3, 690, 800, 4, 0));
    public static final Material ETERNICITE = register(new Identifier("soulforged", "eternicite"), new CrystalMaterial(9, 6, 0, 650, 3000));
