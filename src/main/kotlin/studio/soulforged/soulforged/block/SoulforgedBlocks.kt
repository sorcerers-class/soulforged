...
object SoulforgedBlocks {
    ...
    val SAPPHIRE_ORE: Block = register("sapphire_ore", Block(QuiltBlockSettings.of(Material.AMETHYST)))
    val RUBY_ORE: Block = register("ruby_ore", Block(QuiltBlockSettings.of(Material.AMETHYST)))
    val PADPARADSCHA_ORE: Block = register("padparadscha_ore", Block(QuiltBlockSettings.of(Material.AMETHYST)))
    val STAR_GEM_ORE: Block = register("star_gem_ore", Block(QuiltBlockSettings.of(Material.AMETHYST)))
